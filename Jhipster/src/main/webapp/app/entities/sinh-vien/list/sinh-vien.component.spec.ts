...
import { sampleWithRequiredData } from '../sinh-vien.test-samples';
import { SinhVienService } from '../service/sinh-vien.service';

import { SinhVienComponent } from './sinh-vien.component';
import SpyInstance = jest.SpyInstance;

describe('SinhVien Management Component', () => {
  let comp: SinhVienComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(SinhVienComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.sinhViens()[0]).toEqual(expect.objectContaining({ id: 28148 }));
  });

  describe('trackId', () => {
    it('should forward to sinhVienService', () => {
      const entity = { id: 28148 };
      jest.spyOn(service, 'getSinhVienIdentifier');
      const id = comp.trackId(entity);
      expect(service.getSinhVienIdentifier).toHaveBeenCalledWith(entity);
